...
if __name__ == '__main__':
    ...
    messagebox.showinfo(title = "prompt", message="If you find yourself having to cross a piranha-infested river, here's how to do it...")
    ...
    body_part = simpledialog.askstring(title = "Body Part",prompt = "Enter the name of a Body Part")
